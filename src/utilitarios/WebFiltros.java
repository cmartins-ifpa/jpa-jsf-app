...
/**
 * Tratamento de filtros (acentuação, segurança, logging, etc)
 * Mais info: https://www.caelum.com.br/apostila-java-web/recursos-importantes-filtros
 * 
...
public class WebFiltros implements Filter  {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// adiciona os cabeçalhos de resposta necessários para desativar o cache do navegador.
